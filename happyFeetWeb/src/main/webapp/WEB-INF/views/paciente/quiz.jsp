					...
					<div class="panel panel-default">
						...
						<div align="center">
							<p
								...
								Paciente, antes de que solicite una hora, necesitamos saber cual
								es tu problema, por favor, seleccione una de estas alternativas
							...
							<c:forEach items="${patologias}" var="patologia">
								<tr>
									<td><div>
											...
											<p
												style="text-align: justify; padding-left: 10px; padding-right: 10px; padding-top: 10px;">${patologia.descripcion}</p>
										</div></td>
