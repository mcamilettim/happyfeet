							...
							<div class="container-fluid">
								<div>
									...
									<table class="table table-hover">
										...
										<tr>
											<th><div align="left">Patología tratada</div></th>
											<td align="left">${atencion.patologia.nombre}</td>
										</tr>
										<tr>
											<th><div align="left">Ubicación de la Atención</div></th>
											<td align="left">${atencion.ubicacion.nombre}</td>
										</tr>
										<tr>
											<th><div align="left">Fecha Atención</div></th>
											<td align="left">${atencion.agenda.horario.fecha}</td>
										</tr>
										<tr>
											<th><div align="left">Hora Atención</div></th>
