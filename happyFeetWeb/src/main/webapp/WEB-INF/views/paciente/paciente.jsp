    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Bienvenid<c:if test="${paciente.paramSexo.id==6}">o</c:if><c:if test="${paciente.paramSexo.id==7}">a</c:if></h2>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                   ...
                   <div class="panel panel-primary">
                       <div class="panel-heading">
                           ...
                           <div class="panel-footer">
                               <span class="pull-left">Solicita una hora con un especialista</span>
                ...
                <a href="${contextPath}/paciente/modificardatos">
                   <div class="panel panel-green">
                       <div class="panel-heading">
                           ...
                           <div class="panel-footer">
                               <span class="pull-left">Modifica tus datos</span>
                               <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                               <div class="clearfix"></div>
                           </div>
