		...
		<div class="panel panel-default">
			...
			<div style="text-align: justify;" align="center">
				<p style="padding-left: 10px; padding-right: 10px;">
					Estimado Paciente, por el sistema opera en las comunas de Pudahuel
					y Maipú (Santiago), próximamente abarcarémos más Comunas. <strong>¡ESTAMOS
						TRABAJANDO PARA USTED ! </strong>
				</p>
			</div>
		</div>
		<div class="row">
			<div class="col-md-4 col-md-offset-4" style="top: -90px;">
				<div class="login-panel panel panel-default">
					...
					<div class="panel-body">
						<form:form method="POST" modelAttribute="pacienteForm"
							action="registrarPaciente" enctype="multipart/form-data">
							...
							<spring:bind path="rut">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<form:input type="text" id="rut" path="rut"
										...
										maxlength="10" size="10"></form:input>
							...
							<spring:bind path="diabetico">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									<label>¿Eres Diabetico? <form:checkbox path="diabetico"
											value="1"></form:checkbox>
									</label>
								...
								<div class="form-group ${status.error ? 'has-error' : ''}">
									...
									<form:select path="paramSexo.id">
										<form:options items="${sexos}" itemLabel="valor"
											itemValue="id" required="true" class="form-control" />
									</form:select>
							...
							<div class="form-group ${status.error ? 'has-error' : ''}">
								Foto Perfil<input type="file" class="form-control"
									name="fotoPerfil" value="Subir Foto" accept=".png, .jpg, .jpeg"></input>
							</div>

							<spring:bind path="usuario">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									Password
									<form:input type="password" path="usuario.password"
										class="form-control" required="true"></form:input>
							...
							<spring:bind path="usuario">
								<div class="form-group ${status.error ? 'has-error' : ''}">
									Confirmar Password
									<form:input type="password" path="usuario.passwordConfirm"
										class="form-control" required="true"></form:input>
							...
							<div class="form-check" style="text-align: justify;">
								 <label class="form-check-label"
									for="exampleCheck1"><input type="checkbox" class="form-check-input"
									id="exampleCheck1" required="true">	&nbsp;	&nbsp;Estoy de acuerdo que al ocupar esta
									plataforma gratuita , mis datos, en un futuro, puedan ser ocupados con fines
									estadísticos y comerciales.</label>
							</div>
							<br>
