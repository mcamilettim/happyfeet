			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Buscar Patologias</div>
						<!-- /.panel-heading -->
						<div class="panel-body">
							<div class="table-responsive">
								<form method="POST" action="buscarPatologias">									
									<div class="input-group custom-search-form">
										<input class="form-control" name="textBuscar"
											placeholder="Buscar" type="text"> <span
								...
								<div>
									<form:form method="POST" modelAttribute="patologiaForm"
										action="ingresarPatologia" enctype="multipart/form-data">
											...
											<table class="table table-hover">
												...
												<c:forEach items="${patologias}" var="patologia">
													<tr>
														...
														<td><a href="eliminarPatologia?idPatologia=${patologia.id}">Eliminar</a></td>
														<td><a href="modificarPatologia?idPatologia=${patologia.id}">Modificar</a></td>
													</tr>
												</c:forEach>
													<tr>
														<td></h2> <spring:bind path="nombre">
																<div
														...
														<td><spring:bind path="nombre">
																<div
																	...
																	<input type="file" name="fotoFile" required accept=".png, .jpg, .jpeg">
																</div>
															</spring:bind>
														</td>
														<td>
