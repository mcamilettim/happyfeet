					...
					<div class="panel panel-default">
						...
						<div align="center">
							<p
								...
								con esto, seguir ofreciendo sus servicios en la aplicación.</p>
							<br>
						</div>
					</div>
				</div>
						...
						<div class="panel panel-default">
							...
							<div align="center">
								<p
									...
									pendientes que puede responder.</p>
								<br>
							</div>
									...
									<c:forEach items="${cuestionariosPendientes}"
										...
										<tr>
											...
											<td align="center"><button
													onclick="location.href='${contextPath}/podologo/verCuestionario?id=${cuestionarioPendiente.id}'"
								...
								<table class="table table-bordered">
									...
									<c:forEach items="${cuestionariosRealizados}"
										...
										<tr>
											...
											<td align="center"><button
													onclick="location.href='${contextPath}/podologo/verCuestionario?id=${cuestionarioRealizado.id}'"
