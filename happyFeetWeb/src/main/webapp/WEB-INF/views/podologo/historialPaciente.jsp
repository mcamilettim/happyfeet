				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<strong>Historial Paciente <strong>${paciente.nombres}</strong></strong>
						</div>
						<div>
								...
								<div class="table-responsive">
									<table class="table table-hover">
										...
										<c:forEach items="${atenciones}" var="atencion">
											<tr>
												<td>
													${atencion.agenda.horario.fecha}-${atencion.agenda.horario.hora}</td>
												<td>${atencion.patologia.nombre}</td>
												<td>${paciente.ubicacion.comuna.nombre}</td>
												<td>${atencion.montoCancelado}</td>
												<td><a
													href="${contextPath}/podologo/detalleAtencion?id=${atencion.id}">Ver</a></td>
											</tr>
										</c:forEach>
									</table>
								</div>
						...
						<button
							onclick="location.href='${contextPath}/podologo/pacientes'"
