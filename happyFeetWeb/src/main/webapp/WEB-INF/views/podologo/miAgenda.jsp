            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        ...
                        <li class="divider"></li>
                        <li>
                            <a class="text-center" href="${contextPath}/podologo/index">
            ...
            <form action="ingresarHora" method="post">  
	            <div class="row">        
		            <div class="col-lg-3 col-md-6">
		            	<label for="diaAgenda">Seleccione dia de la Agenda:</label>
		            	<input type="date" placeholder="Dia de la Agenda" name="diaAgenda">            	
					</div>
				</div>
				<div class="row">
					<div class="col-lg-3 col-md-6">
		            	<label for="diaAgenda">Hora Inicio Hora</label>
		            	<input type="time" placeholder="Dia de la Agenda" name="horaInicioAgenda">            	
					</div>
					<div class="col-lg-3 col-md-6">
		            	<label for="diaAgenda">Hora Fin Hora</label>
		            	<input type="time" placeholder="Dia de la Agenda" name="horaFinAgenda">            
					</div>
					<div class="col-lg-3 col-md-6">
					<select name="estadoHorario">
						<c:forEach items="${estadosHorario}" var="estadoHorario">
							<option value="${estadoHorario.id}">${estadoHorario.valor}</option>						
						</c:forEach> 
						</select>     	
					</div>
				</div>
