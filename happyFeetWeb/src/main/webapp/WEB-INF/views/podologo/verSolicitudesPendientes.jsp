				...
				<div class="col-lg-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">
								<strong>Solicitudes Pendientes
									${solicitudesEncontradas.size()}</strong>
							</div>
							<div align="left">
								<p
									style="text-align: justify; padding-left: 10px; padding-right: 10px; padding-top: 10px;">
									A continuación se listan las solicitudes de atención
									pendientes.<br>
								</p>
										...
										<div class="col-xs-6">
											<table>
												<thead>
													<tr>
													<tr>
														<th>Buscar por Fecha</th>
													</tr>
												</thead>
												<tbody>
													<tr>
														<td><input type="text"  name ="fechaBusqueda" id="datePicker" class="form-control" required /></td>
													</tr>
													<tr>
														<td></td>
													</tr>
													<tr>
														<td style="padding-top: 10px;"><input type="submit"
															value="Buscar" class="btn btn-info" /> <input
							...
							<table class="table">
								<c:if
									test="${not empty solicitudes && empty solicitudesEncontradas}">
									<thead>
										<tr>
										<tr>
											<th>Atención</th>
									...
									<tbody>
										<c:forEach items="${solicitudes}" var="solicitud">
											<tr>
												<td>${solicitud.horario.fecha}</td>
												<td>${solicitud.paciente.ubicacion.comuna.nombre}</td>
												<td><fmt:formatNumber
														value="${solicitud.presupuesto.total}" type="currency"
														pattern="#,##0" /></td>
												<td><a
													href="${contextPath}/podologo/detalleSolicitud?id=${solicitud.id}">Ver</a></td>
											</tr>
										</c:forEach>
									</tbody>
								</c:if>
