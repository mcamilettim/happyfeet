				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">
							<strong>${cuestionariopodologo.cuestionario.titulo}</strong>
						</div>
						<br>
						<c:if
							test="${cuestionariopodologo.paramEstadoCuestionario.valor eq 'Sin Resolver'}">
							<div align="center">
								<p
									style="text-align: justify; padding-left: 10px; padding-right: 10px;">Al
									responder este cuestionario usted podrá seguir ofreciendo sus servicios en la aplicación gratuitamente.</p>
								<br>
							</div>
							<form action="guardarCuestionario" method="post">
								<table class="table table-bordered">
									...
									<tr>
										<td align="left"><p
												style="text-align: justify; padding-left: 10px; padding-right: 10px;">${cuestionariopodologo.cuestionario.preguntas.pregunta_uno}.</p></td>
									...
									<tr>
										<td align="left"><p
												style="text-align: justify; padding-left: 10px; padding-right: 10px;">${cuestionariopodologo.cuestionario.preguntas.pregunta_dos}.</p></td>
									...
									<tr>
										<td align="left"><p
												style="text-align: justify; padding-left: 10px; padding-right: 10px;">${cuestionariopodologo.cuestionario.preguntas.pregunta_tres}.</p></td>
						...
						<c:if
							test="${cuestionariopodologo.paramEstadoCuestionario.valor eq 'Resuelto'}">
							...
							<table class="table table-bordered">
								...
								<tr>
									<td align="left"><p
											style="text-align: justify; padding-left: 10px; padding-right: 10px;">${cuestionariopodologo.cuestionario.preguntas.pregunta_uno}.</p></td>
									<td align="center"><Strong>${cuestionariopodologo.respuesta_uno}</Strong></td>
								</tr>
								<tr>
									<td align="left"><p
											style="text-align: justify; padding-left: 10px; padding-right: 10px;">${cuestionariopodologo.cuestionario.preguntas.pregunta_dos}.</p></td>
									<td align="center"><Strong>${cuestionariopodologo.respuesta_dos}</Strong></td>
								</tr>
								<tr>
									<td align="left"><p
											style="text-align: justify; padding-left: 10px; padding-right: 10px;">${cuestionariopodologo.cuestionario.preguntas.pregunta_tres}.</p></td>
									<td align="center"><Strong>${cuestionariopodologo.respuesta_tres}</Strong></td>
								</tr>
							</table>
								</div>
								<div align="center">
								<p
									...
									Usted ya respondió este cuestionario .</Strong>
								</p>
								<br>
							</div>
						</c:if>
