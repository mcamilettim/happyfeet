...
<head>
	...
	<link rel="manifest" href="${contextPath}/resources/icon/manifest.json">
	<meta name="msapplication-TileColor" content="#ffffff">
	<meta name="msapplication-TileImage" content="${contextPath}/resources/icon/ms-icon-144x144.png">
    ...
    <!-- Morris Charts CSS -->
    <link href="${contextPath}/resources/vendor/morrisjs/morris.css" rel="stylesheet">
...
<body>
    ...
    <script src="${contextPath}/resources/vendor/morrisjs/morris.min.js"></script>
