...
<body>
	...
	<div id="wrapper">
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="${contextPath}/admin/podologos"><i
								class="fa fa-user-md fa-fw"></i><Strong>Podólogos</Strong></a></li>
		...
		<div id="page-wrapper">
			...
			<c:if
				test="${fn:length(podologos) == 0 && fn:length(podologos) == 0}">
				<div class="alert alert-warning" align="center">
					<Strong>No existen Podólogos en el Sistema</Strong>
				</div>
			</c:if>
			 

			<c:if test="${not empty podologos}">
				<div class="row">
					<div class="col-lg-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<strong>Podólogos <span class="badge">
										${podologos.size()}</span></strong>
							</div>
							<br>
							<div align="center">
								<p
									style="text-align: justify; padding-left: 10px; padding-right: 10px;">Podólogos que se encuentran operando en la aplicación.</p>
								<br>
							</div>
							<div class="table-responsive">
								...
								<table class="table table-bordered">
									...
									<c:forEach items="${podologos}"
										var="podologo">
										<tr>
										<td align="center">${podologo.rut}</td>
											<td align="center">${podologo.nombres}</td>
											<td align="center">${podologo.fono}</td>
											<td align="center">${podologo.ubicacion.comuna.nombre}</td>
