                             ...
                             <form method="POST" action="buscarPacientes">
										...
										<div>									
											 <table class="table table-hover">
												<tr>
													<th>Nombre Completo</th><th>Comuna</th><th>Rut</th><th></th>
												</tr>
												<c:forEach items="${podologos}" var="podologo">
													<tr>
														<td> ${podologo.nombres}  ${podologo.apellidos}</td>
														<td> ${podologo.ubicacion.comuna.nombre}</td>		
														<td> ${podologo.rut}</td>								
														<td> <a href="${contextPath}/admin/modificarDatosPodologo?rut=${podologo.rut}">Modificar Datos</a></td>			   
												    </tr>
												</c:forEach>
											</table>
										</div>
