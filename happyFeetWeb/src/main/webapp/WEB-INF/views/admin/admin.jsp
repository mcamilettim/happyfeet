                    ...
                    <ul class="nav" id="side-menu">
                    	<li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                ...
                                <center><span class="text-info">Administrador</span></center>
                            </div>
                            <!-- /input-group -->
                        </li>
                        <li>
                            <a href="${contextPath}/admin/index"><i class="fa fa-dashboard fa-fw"></i> Inicio</a>
                        </li>
                        <li>
                            <a href="${contextPath}/admin/modificardatos"><i class="fa fa-gear fa-fw"></i> Modificar mis datos</a>
                        </li>
                        <li>
                            <a href="${contextPath}/admin/verPacientes"><i class="fa fa-table fa-fw"></i> Ver Pacientes</a>
                        </li>
                        <li>
                            <a href="${contextPath}/admin/verPodologos"><i class="fa fa-edit fa-fw"></i> ver Podologos</a>
                        </li>
                        <li>
                            <a href="${contextPath}/admin/modificarPrecioAtencion"><i class="fa fa-edit fa-fw"></i> Modificar Valor Atención</a>
                        </li>
                        <li>
                            <a href="${contextPath}/admin/listarPatologias"><i class="fa fa-edit fa-fw"></i> Listar Patologias</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
