            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
                         <form method="POST" action="${contextPath}/forgot" name="loginForm" id="actionForm">
                         ...
                         <div class="form-group ${error != null ? 'has-error' : ''}" id="formbody">
							...
							<c:otherwise>
								<center><h2>¿Olvidaste tu contraseña?</h2></center>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Ingresa tu email" name="email" type="email" required="required">
                                </div>
                                <button type="button" id="submit1" class="btn btn-lg btn-primary btn-block g-recaptcha" data-sitekey="6LeDCzIUAAAAAJ_GTQ9AlDWh8SiVPcNPcV8vMRCF" data-callback="onSubmit">Recuperar</button>
