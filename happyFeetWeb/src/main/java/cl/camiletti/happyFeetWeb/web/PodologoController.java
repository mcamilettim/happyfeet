...
public class PodologoController {
    ...
    public String buscarPaciente(@ModelAttribute("podologo")Podologo podologo, Model model, @RequestParam("selectBuscar") String criterioBusqueda,@RequestParam("textBuscar") String textBuscar) {
    ...
    public String cargarHistorialPaciente(@ModelAttribute("podologo")Podologo podologo, Model model, @RequestParam("rut") String rutPaciente,@ModelAttribute("pacientes")List<Paciente> pacientes){
    ...
    public String detalleAtencion(@ModelAttribute("paciente")Paciente paciente,@ModelAttribute("podologo")Podologo podologo, Model model, @RequestParam("id") int idAtencion,@ModelAttribute("pacientes")List<Paciente> pacientes){
    ...
    public String diagnostico(@ModelAttribute("paciente")Paciente paciente,
    		@ModelAttribute("podologo")Podologo podologo,@ModelAttribute("atencion")Atencion atencion , Model model,  @ModelAttribute("pacientes")List<Paciente> pacientes){
    ...
    public String verMensajes(@ModelAttribute("paciente")Paciente paciente,
    		@ModelAttribute("podologo")Podologo podologo, Model model, @ModelAttribute("pacientes")List<Paciente> pacientes, @RequestParam("rut")String rutPaciente){
    	podologo=podologoService.findByEmail(podologo.getEmail());
    ...
    public String enviarMensaje(@ModelAttribute("mensajeForm") Mensaje mensaje, BindingResult bindingResult, @ModelAttribute("paciente")Paciente paciente,
    		@ModelAttribute("podologo")Podologo podologo, Model model, @ModelAttribute("pacientes")List<Paciente> pacientes){
    	podologo=podologoService.findByEmail(podologo.getEmail());
    	ArrayList<Mensaje> conversacion=(ArrayList<Mensaje>) mensajeService.cargarConversacion(podologo, paciente);
    ...
    public String modificarpost(@ModelAttribute("podologoForm") Podologo podologoForm, BindingResult bindingResult, Model model) {
...
//	        	podologo.setEdad(dateUtil.getAge(podologoForm.getFechaNacimiento()));
    ...
    public String buscarSolicitud(@ModelAttribute("podologo")Podologo podologo,@ModelAttribute("solicitudes")List<Solicitudatencion> solicitudes, Model model, @RequestParam("fechaBusqueda") String fechaBusqueda) {
    ...
    public String miAgenda(Model model, @RequestParam("diaAgenda")@DateTimeFormat(pattern="dd/MM/yyyy") String diaAgenda, 
    	@RequestParam("horaInicioAgenda") @DateTimeFormat(pattern = "dd.MM.yyyy HH:mm:ss.SSSZ") String horaInicio, @RequestParam("horaFinAgenda")  @DateTimeFormat(pattern = "dd.MM.yyyy HH:mm:ss.SSSZ") String horaFin, @RequestParam("estadoHorario") int estadoHorario) {
    	User user = (User)SecurityContextHolder.getContext().getAuthentication().getPrincipal();
    	Podologo podologo=podologoService.findByEmail(user.getUsername()); 
